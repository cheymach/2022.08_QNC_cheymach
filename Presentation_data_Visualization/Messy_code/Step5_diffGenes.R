...
vplot <- ggplot(myTopHits.df) +
  ...
  labs(title="Differentially expressed genes (WTC11 vs NPC) ",
...
#Claudia's enhanced volcano plot
#negative values mean lower for NPCs, higher for WTC11
#based on this instruction: https://bioconductor.org/packages/devel/bioc/vignettes/EnhancedVolcano/inst/doc/EnhancedVolcano.html#download-the-package-from-bioconductor
#not yet sure where TDGF1 is and how to label which one is higher for NPC vs WTC11
geneNames = rownames(myTopHits)
EnhancedVolcano(myTopHits.df, 
                lab = rownames(myTopHits),
               selectLab = c('RP11-777B9.5','GREB1L','LINC00371','MTRNR2L6','TDGF1'),
                 x='logFC',
                y='adj.P.Val',
                pCutoff = .01)
...
datatable(diffGenes.df, 
          ...
          caption = 'Table 1: DEGs between WTC11 and NPCs',
