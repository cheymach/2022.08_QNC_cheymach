...
#C edited out. library(gameofthrones) #because...why not.  Install using 'devtools::install_github("aljrico/gameofthrones")'
library(heatmaply) #for making interactive heatmaps using plotly
#library(d3heatmap) #for making interactive heatmaps using D3. C couldn't install. 
...
#Claudia's edited heatmap; some issue w both now
...
module.assign.pivot <- pivot_longer(module.assign.df, # dataframe to be pivoted
                          cols = 1:175, # column names to be stored as a SINGLE variable
